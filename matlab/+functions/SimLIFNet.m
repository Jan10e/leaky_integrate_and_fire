...
%   gaussian noise source of current added to the corresponding neuron,
...
%
% === Outputs ===
% spk : A cell array of spike times, each row corresponding to a neuron and
...
% ratio of the voltage minus baseline to the threshold minus baseline, and
...
% neurons and, importantly, the number of non-zero synaptic connections
...
for k=2:K
    ...
    synapses = accumarray(Wsparse(:,2),spikeEffects,[length(W) 1],@sum,0);
